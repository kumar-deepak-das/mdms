...
<body>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{asset('public/dream/assets/images/banner-right-image.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
            <img src="{{asset('public/dream/assets/images/about-left-image.png')}}" alt="">
          </div>
        </div>
              ...
              <div class="col-lg-3">
                <div class="contact-info">
                  <ul>
                    <li>
                      <div class="icon">
                        <img src="{{asset('public/dream/assets/images/contact-icon-01.png')}}" alt="email icon">
                      </div>
                      <a href="#">info@company.com</a>
                    </li>
                    <li>
                      <div class="icon">
                        <img src="{{asset('public/dream/assets/images/contact-icon-02.png')}}" alt="phone">
                      </div>
                      <a href="#">+001-002-0034</a>
                    </li>
                    <li>
                      <div class="icon">
                        <img src="{{asset('public/dream/assets/images/contact-icon-03.png')}}" alt="location">
                      </div>
  ...
  <div id="login" class="contact-us section">
    <div class="container">
      <div class="row">
        <div class="col-md-5 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="" method="post">
            <div class="row">
              <div class="col-md-10 offset-md-1">
                <div class="section-heading">
                  <h2><em>Reviewer Login</em></h2>
                </div>
                <A class="btn btn-lg btn-block btn-info" href="./reviewer">Click Here to Login</A>
              </div>
            </div>
          </form>
        </div>

        <div class="col-md-5  offset-md-2 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="" method="post">
            <div class="row">
              <div class="col-md-10 offset-md-1">
                <div class="section-heading">
                ...
                <A class="btn btn-lg btn-block btn-info" href="./admin">Click Here to Login</A>
                </div>
              </div>
            </div>
          </form>
